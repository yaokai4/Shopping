...
public class NoticesController {
    ...
    public ResultVo LookNoticesById (@PathVariable("id") String id) {
        ...
        if (i == 1){
            return new ResultVo(true, StatusCode.OK,"設定に成功した");
        }
        return new ResultVo(true, StatusCode.ERROR,"設定に失敗しました");
    }
    ...
    public ResultVo queryNotices (HttpSession session){
        ...
        return new ResultVo(true,StatusCode.OK,"照会が成功した",noticesList);
    }

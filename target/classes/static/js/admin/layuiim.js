    ...
    layim.on('chatChange', function(res){
        ...
        if(type === 'friend'){
            ...
            if(res.data.status==="offline"){
                layim.setChatStatus('<span style="color:#FF5722;">オンラインはありません</span>'); //模拟标注好友在线状态
            }else if(res.data.status==="online"){
                layim.setChatStatus('<span style="color:#777777;">オンライン</span>'); //模拟标注好友在线状态
            }
        }else if(type === 'group'){
            //模拟系统消息
            // layim.getMessage({
